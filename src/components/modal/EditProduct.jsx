  ...
  return (
    <div>
      <div>
        ...
        <label htmlFor="my_modal_7" className="btn bg-slate-800  rounded-full ">
          <MdOutlineEditCalendar className="w-4 h-4 text-white" />
        </label>
        ...
        <div className="modal" role="dialog">
          <div className="modal-box">
            <h3 className="text-center font-thin">Please add your product you want!</h3>
            <p className="py-4">
              {" "}
              <div className="bg-neutral-50   py-5 px-12  rounded-xl  shadow-xl border-2">
                <form
                  onSubmit={handleSubmit}
                  className="flex flex-col  xl:grid xl:grid-cols-2 md:grid md:grid-cols-2 gap-4"
                >
                  <div>
